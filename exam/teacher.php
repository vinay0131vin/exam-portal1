...
?>
<div align="center">
<img src="anits.jpg" width="1200"px height="150"px>
</div>
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right">
      ...
      <li><a href="http://localhost/project/exam/faclogin/faclogin/login.php"><span class="glyphicon glyphicon-user"></span>Logout</a></li>
    </ul>
  </div>
</nav>
